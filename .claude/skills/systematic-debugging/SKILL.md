...
## Parallelizing Independent Failures
...
3. **Check Recent Changes**
   ...
   - Git diff, recent commits — use cbm `detect_changes` to map the diff to affected symbols and risk
...
5. **Trace Data Flow**
   ...
   **Quick version:**
   ...
   - Keep tracing up until you find the source — use cbm `trace_path` to walk the call graph instead of grepping
